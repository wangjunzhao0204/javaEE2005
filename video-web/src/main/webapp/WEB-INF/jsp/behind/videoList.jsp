...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <!-- 查询相关组件 -->
            <form class="navbar-form navbar-right" id="queryForm" action="${pageContext.request.contextPath}/video/list" method="post">
...
<div class="container">
    <div class="navbar-right" style="padding-right: 17px">
        ...
        <a href="javascript:void(0)" onclick="queryVideo(${page.prePage})">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="javascript:void(0)" onclick="queryVideo(${page.nextPage})">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="javascript:void(0)" onclick="queryVideo(${page.navigateLastPage})">尾页</a>
